...
# ==============================================================================
# Αυτά τα αρχεία θα δημιουργηθούν αυτόματα στον φάκελό σου
FILES = {
    "users": "users.json",
...
# Helper: Μετατροπή ημερομηνιών για να αποθηκεύονται σωστά
def date_handler(obj):
    if isinstance(obj, (datetime, date)):
        return obj.isoformat()
    return obj

# --- ΦΟΡΤΩΣΗ ΔΕΔΟΜΕΝΩΝ (LOAD) ---
def load_data():
    # 1. Users
    ...
    # 2. History (Έσοδα) - Μετατροπή ημερομηνιών από string σε date object
...
if not st.session_state.authenticated:
    ...
    # --- 4. WEATHER & PRECISION (IMPROVED GPS/CITY) ---
        ...
        if lat is not None and lon is not None:
            ...
            try:
                ...
                with st.container(border=True):
                    ...
                    k1.metric("Μέγιστη", f"{tmax}°C")
                    k2.metric("Ελάχιστη", f"{tmin}°C")
                    k3.metric("GDD", f"{gdd:.1f}")
